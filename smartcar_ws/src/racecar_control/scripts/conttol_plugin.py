...
LRW_topic   = '/racecar/left_rear_wheel_velocity_controller/command'.format(car_name)
RRW_topic   = '/racecar/right_rear_wheel_velocity_controller/command'.format(car_name)
LFW_topic   = '/racecar/left_front_wheel_velocity_controller/command'.format(car_name)
RFW_topic   = '/racecar/right_front_wheel_velocity_controller/command'.format(car_name)
LSH_topic   = '/racecar/left_steering_hinge_position_controller/command'.format(car_name)
RSH_topic   = '/racecar/right_steering_hinge_position_controller/command'.format(car_name)
